...
module.exports = {
	name: 'collagepixel',
	guide: '**!collagepixel [Eth Addresses (Seperate Each Address by Comma if Multiple)] [Options]**\nor\n**!collagep [[Eth Addresses (Seperate Each Address by Comma if Multiple)] [Options]**\n\n**__Options__**\n**Sort Method:** Random \n**Columns:** 2-30\n**Without IDs:** ExcludeID\n\nExample: **!collagepixel 0xD4091d661A44648D61bd3bb51E129d0d60892056 random excludeid 10**\nor\nExample: **!collagep 0xD4091d661A44648D61bd3bb51E129d0d60892056 5**',
	alias: ['collagep'],
	async execute(message, client, collage) {
		...
		let assets = await client.extra.callAllWallets(await client.extra.ens2eth(client, strings[1]), 'kinkyskullx');

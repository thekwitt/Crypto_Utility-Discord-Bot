...
module.exports = {
	name: 'collageskullx',
	guide: '**!collageskullx [Eth Addresses (Seperate Each Address by Comma if Multiple)] [Options]**\nor\n**!collages [[Eth Addresses (Seperate Each Address by Comma if Multiple)] [Options]**\n\n**__Options__**\n**Sort Method:** Random or Realm\n**Columns:** 2-30\n**Filter Method:** Any Realm Trait\n**Without IDs:** ExcludeID\n\nExample: **!collageskullx 0xD4091d661A44648D61bd3bb51E129d0d60892056 realm excludeid 10**\nor\nExample: **!collages 0xD4091d661A44648D61bd3bb51E129d0d60892056 forest 25**',
	alias: ['collages'],
	async execute(message, client, collage) {
		...
		let assets = await client.extra.callAllWallets(await client.extra.ens2eth(client, strings[1]), '0x1dc5d3b2162f9500d7ddec14eb0ba9ccb43bc20c');
